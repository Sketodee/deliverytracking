...
const Hero = () => {
  return (
    <div className='py-5 text-center'>
      ...
      <p>Welcome to Cristex. We understand how important it is for you to receive your packages on time, and that's why we offer a comprehensive and user-friendly tracking system that allows you to monitor the status of your shipments in real-time. </p>
      <p> Its time to adapt your business to keep up with how the world of commerce is evolving. Onelineize your offline logistics service, Booking, controlling, and monitoring your shipments are all simple with Cristex</p>
