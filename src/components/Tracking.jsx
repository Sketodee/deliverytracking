                ...
                <div className="card-body">
                    ...
                    <div class="card ">
                        <div class="card-body row">
                            ...
                            <div class="col"> <strong>Shipping BY:</strong> <br /> BLUEDART, | <i class="fas fa-phone"></i> +1598675986 </div>
                    ...
                    <hr />
                    <Link to="/" class="btn btn-warning maroon-bg text-white" data-abc="true"> <i class="fa fa-chevron-left"></i> Back to Home</Link>
